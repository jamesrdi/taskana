...
import io.kadai.AtIoKadaiRootPackageLoggingTestClass;
...
import outside.of.io.kadai.OutsideOfIoKadaiPackageLoggingTestClass;
...
class LoggingAspectTest {
  ...
  void should_NotLogMethodCalls_When_ClassDoesNotResideWithinKadaiPackage() {
    OutsideOfIoKadaiPackageLoggingTestClass loggingTestClass =
        new OutsideOfIoKadaiPackageLoggingTestClass();
  ...
  void should_LogMethod_When_ClassResidesAtKadaiRootPackage() {
    AtIoKadaiRootPackageLoggingTestClass loggingTestClass =
        new AtIoKadaiRootPackageLoggingTestClass();
    TestLogger logger = TestLoggerFactory.getTestLogger(loggingTestClass.getClass());
