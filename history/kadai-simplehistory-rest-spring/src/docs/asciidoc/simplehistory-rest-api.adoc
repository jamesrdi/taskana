= KADAI History module RESTful API Documentation

== Overview
This is the REST documentation for http://kadai.io)[KADAI]'s simplehistory REST endpoints.
...
The table below is an addition to the already documented KADAI REST Service ErrorCodes
