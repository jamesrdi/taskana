...
public class TaskHistoryEventController {
  ...
  public TaskHistoryEventController(
    ...
    this.simpleHistoryService.initialize(KadaiEngine.buildKadaiEngine(kadaiConfiguration));
  ...
  public ResponseEntity<TaskHistoryEventRepresentationModel> getTaskHistoryEvent(
      @PathVariable String historyEventId) throws KadaiHistoryEventNotFoundException {
