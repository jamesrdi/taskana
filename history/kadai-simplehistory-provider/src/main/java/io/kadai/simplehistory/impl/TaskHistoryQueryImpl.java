...
public class TaskHistoryQueryImpl implements TaskHistoryQuery {
  ...
  private final KadaiHistoryEngineImpl kadaiHistoryEngine;
  ...
  public TaskHistoryQueryImpl(KadaiHistoryEngineImpl kadaiHistoryEngine) {
    this.kadaiHistoryEngine = kadaiHistoryEngine;
    this.orderBy = new ArrayList<>();
    this.orderColumns = new ArrayList<>();
    this.joinWithUserInfo = kadaiHistoryEngine.getConfiguration().isAddAdditionalUserInfo();
  }
  ...
  public List<TaskHistoryEvent> list() {
    ...
    try {
      ...
      result = kadaiHistoryEngine.getSqlSession().selectList(LINK_TO_MAPPER, this);
      return result;
  ...
  public List<TaskHistoryEvent> list(int offset, int limit) {
    ...
    try {
      ...
      result = kadaiHistoryEngine.getSqlSession().selectList(LINK_TO_MAPPER, this, rowBounds);
      return result;
    } catch (SQLException e) {
      LOGGER.error(SQL_EXCEPTION_MESSAGE, e.getCause());
      return result;
  ...
  public List<String> listValues(
    ...
    try {
      kadaiHistoryEngine.openConnection();
      result = kadaiHistoryEngine.getSqlSession().selectList(LINK_TO_VALUE_MAPPER, this);
      return result;
    } catch (SQLException e) {
      LOGGER.error(SQL_EXCEPTION_MESSAGE, e.getCause());
      return result;
  ...
  public TaskHistoryEvent single() {
    ...
    try {
      kadaiHistoryEngine.openConnection();
      result = kadaiHistoryEngine.getSqlSession().selectOne(LINK_TO_MAPPER, this);
  ...
  public long count() {
    ...
    try {
      kadaiHistoryEngine.openConnection();
      rowCount = kadaiHistoryEngine.getSqlSession().selectOne(LINK_TO_COUNTER, this);
