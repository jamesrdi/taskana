...
public interface ReviewRequiredProvider {
  ...
  /**
   * Provide the active {@linkplain KadaiEngine} which is initialized for this KADAI
   * installation.
   *
   ...
   * io.kadai.common.api.security.UserPrincipal} and {@linkplain
   * io.kadai.common.api.security.GroupPrincipal} as in {@linkplain
   ...
   *     executed instead of {@linkplain io.kadai.task.api.TaskService#completeTask(String)}.
   *     False, if {@linkplain io.kadai.task.api.TaskService#completeTask(String)} can be
   *     executed regularly
   */
