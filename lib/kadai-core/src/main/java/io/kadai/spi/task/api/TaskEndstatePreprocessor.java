...
public interface TaskEndstatePreprocessor {
   ...
   * io.kadai.task.api.TaskState#END_STATES end state}. A {@linkplain Task} goes into an end
   ...
   * io.kadai.common.api.security.GroupPrincipal} as in the methods mentioned above.
   *
