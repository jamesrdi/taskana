...
public class KadaiEngineImpl implements KadaiEngine {
    ...
    if (this.kadaiConfiguration.isJobSchedulerEnabled()) {
      KadaiConfiguration configuration =
          new KadaiConfiguration.Builder(this.kadaiConfiguration)
              ...
              .build();
      KadaiEngine kadaiEngine = KadaiEngine.buildKadaiEngine(configuration, EXPLICIT);
      RealClock clock =
          new RealClock(
  ...
  public static KadaiEngine createKadaiEngine(
      KadaiConfiguration kadaiConfiguration, ConnectionManagementMode connectionManagementMode)
      throws SQLException {
    return new KadaiEngineImpl(kadaiConfiguration, connectionManagementMode);
  }
  ...
  public UserService getUserService() {
    return new UserServiceImpl(
        internalKadaiEngineImpl, sessionManager.getMapper(UserMapper.class));
  }
  ...
  private void initializeDbSchema(KadaiConfiguration kadaiConfiguration) throws SQLException {
    DbSchemaCreator dbSchemaCreator =
        new DbSchemaCreator(
            kadaiConfiguration.getDataSource(), kadaiConfiguration.getSchemaName());
