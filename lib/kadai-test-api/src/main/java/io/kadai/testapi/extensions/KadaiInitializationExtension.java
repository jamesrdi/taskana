...
public class KadaiInitializationExtension
  ...
  public void postProcessTestInstance(Object testInstance, ExtensionContext context)
    ...
    if (isTopLevelClass(testClass)
        || AnnotationSupport.isAnnotated(testClass, CleanKadaiContext.class)
  ...
  public void preDestroyTestInstance(ExtensionContext context) {
    if (isTopLevelClass(context.getRequiredTestClass())) {
      ...
      KadaiEngineImpl kadaiEngineImpl =
          (KadaiEngineImpl) entityMap.get(KadaiEngineImpl.class);
  ...
  private static KadaiConfiguration.Builder createDefaultKadaiConfigurationBuilder(
      Store store) {
